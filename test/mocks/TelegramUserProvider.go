...
// TelegramUserProvider is an autogenerated mock type for the TelegramUserProvider type
type TelegramUserProvider struct {
	mock.Mock
}

// CreateUser provides a mock function with given fields: user
func (_m *TelegramUserProvider) CreateUser(user *models.TelegramUser) error {
	ret := _m.Called(user)
...
func (_m *TelegramUserProvider) GetByID(id uuid.UUID) (*models.TelegramUser, error) {
	ret := _m.Called(id)
...
func (_m *TelegramUserProvider) GetByTelegramID(telegramID int64) (*models.TelegramUser, error) {
...
func (_m *TelegramUserProvider) GetByUsername(username string) (*models.TelegramUser, error) {
...
func (_m *TelegramUserProvider) GetUsersByState(state string) ([]*models.TelegramUser, error) {
	ret := _m.Called(state)
...
// NewTelegramUserProvider creates a new instance of TelegramUserProvider. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTelegramUserProvider(t interface {
	mock.TestingT
	Cleanup(func())
}) *TelegramUserProvider {
	mock := &TelegramUserProvider{}
	mock.Mock.Test(t)
